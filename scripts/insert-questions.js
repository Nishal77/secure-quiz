/**
 * Utility script to insert quiz questions into Supabase (Node.js version)
 * 
 * Usage:
 ...
 * 3. Run: node scripts/insert-questions.js
 */
...
if (!EVENT_ID) {
  console.error('❌ Missing EVENT_ID. Set EVENT_ID in .env file');
  process.exit(1);
}
